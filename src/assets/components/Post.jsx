...
function Post({ content, loggedUser }) {
    const {
        id,
        accountName,
        verified,
    ...
    const { loggedAccountName } = loggedUser
    ...
    function handlePostComment() {
        ...
        const newCommentObj = {
            ...
            text: text,
            comment_Account: loggedAccountName,
            comment_Account_Img: "/public/profile.jpg",
            time: "Adesso"
        };
    ...
    return (
        ...
        <>
            <div className="instaPost w-full text-left px-4 mt-5">
                ...
                <div id="default-carousel" className="relative w-full" data-carousel="slide">
                    <div className="relative aspect-square overflow-hidden rounded-lg">
                        {postImgSrc.map((postImgSrcSingle, i) => (
                            <div key={i} className={`${i === currentSlide ? "block" : "hidden"} h-full w-full duration-700 ease-in-out`} data-carousel-item>
                    ...
                    {postImgSrc.length > 1 && (
                        <>
                            <button
                                type="button"
                                className={`absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none disabled:cursor-default disabled:opacity-0 !bg-transparent !border-none`}
                                onClick={prevSlide}
                            ...
                            <button
                                type="button"
                                className={`absolute top-0 end-0 z-10 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none disabled:cursor-default disabled:opacity-0 !bg-transparent !border-none`}
                                onClick={nextSlide}
                ...
                {postImgSrc.length > 1 && (
                    <div className="w-25 mx-auto bg-gray-100 p-[2px] rounded-full mt-2 flex justify-center space-x-3 rtl:space-x-reverse">
                        {postImgSrc.map((_, i) => (
                            <button
                                key={i}
                                type="button"
                ...
                <div className="cardFooter flex justify-between">
                    ...
                    <div className="footerLeftSide flex py-3 text-center gap-3 items-center">
                        <div className="likes">
                            <button
                                className="flex items-center gap-[3px] !bg-transparent"
                                onClick={toggleLike}
                            >
                                {isLiked
                        ...
                        <div className="comments group">
                            <button onClick={togglePostComment} className="flex items-center gap-[3px] !bg-transparent">
                        ...
                        <div className="forward group">
                            <button className="flex items-center gap-[3px] !bg-transparent">
                ...
                <div className="caption mb-1">
                    <div className="nameBox text-left">
                        ...
                        <div className=" mt-2 tags text-sm flex flex-wrap gap-x-2 text-blue-500">
                            {tags.map((tag, i) =>
                ...
                {langDetected !== "it" &&
                    <button className="block !bg-transparent" onClick={toggleTranslation}>
                ...
                <button className="!bg-transparent" onClick={toggleComments}>
